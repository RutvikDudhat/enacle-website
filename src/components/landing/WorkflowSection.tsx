...
const steps = [
  { icon: UserPlus, title: "Capture Leads", desc: "Automatically capture leads from website, referrals, and campaigns.", color: "from-solar-yellow to-solar-orange" },
  { icon: Handshake, title: "Close Deals", desc: "Track proposals, quotes, and negotiations through your pipeline.", color: "from-solar-orange to-solar-orange/80" },
  { icon: Wrench, title: "Manage Install", desc: "Schedule, track, and manage every installation with precision.", color: "from-solar-orange/80 to-solar-green" },
  { icon: CreditCard, title: "Collect Payment", desc: "Automated invoicing and payment collection for every project.", color: "from-solar-green to-solar-green/60" },
];
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {steps.map((step, i) => (
            <div key={step.title} className={`relative ${isVisible ? "animate-fade-up" : "opacity-0"}`} style={{ animationDelay: `${i * 0.15}s` }}>
              <div className="group text-center p-6 rounded-2xl border border-border bg-card hover:shadow-xl hover:shadow-solar-orange/10 transition-all duration-300 hover:-translate-y-1">
              ...
              {i < 3 && (
                <div className="hidden md:flex absolute top-1/2 -right-4 -translate-y-1/2 z-10 text-solar-orange/40">
