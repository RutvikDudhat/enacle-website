...
export default function AnalyticsSection() {
  ...
  return (
    <section ref={ref} className="section-padding relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-solar-purple/5 blur-3xl" />
        ...
        <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-6 ${isVisible ? "animate-fade-up" : "opacity-0"}`} style={{ animationDelay: "0.15s" }}>
          ...
          <div className="glass-card p-6 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <TrendingUp className="w-5 h-5 text-solar-purple" />
          ...
          <div className="glass-card p-6">
            <div className="flex items-center gap-2 mb-4">
              <PieChart className="w-5 h-5 text-solar-pink" />
              <span className="font-bold">Lead Sources</span>
            </div>
            <div className="relative w-32 h-32 mx-auto mb-4">
              <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                <circle cx="18" cy="18" r="14" fill="none" stroke="#7B68EE" strokeWidth="4" strokeDasharray="35 65" strokeLinecap="round" />
                <circle cx="18" cy="18" r="14" fill="none" stroke="#FD71AF" strokeWidth="4" strokeDasharray="25 75" strokeDashoffset="-35" strokeLinecap="round" />
            ...
            <div className="space-y-2">
              {[{ l: "Website", c: "bg-solar-purple", v: "35%" }, { l: "Referrals", c: "bg-solar-pink", v: "25%" }, { l: "Social", c: "bg-green-400", v: "22%" }, { l: "Ads", c: "bg-amber-400", v: "18%" }].map((s) => (
          ...
          <div className="glass-card p-6 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <BarChart className="w-5 h-5 text-solar-purple" />
