...
const ALL_PRODUCTS = [
  ...
  // Solar
  { id:26, icon: SunMedium,       name: "Solar ERP",          tagline: "ERP built for solar businesses",       desc: "End-to-end ERP from lead to installation to after-sales — built for solar operators.", category: "Solar", group: "solar", color: "from-amber-400 to-yellow-500",   accent: "#f59e0b", slug: "solar" },
  { id:27, icon: BatteryCharging, name: "Energy Monitor",     tagline: "Real-time energy production",          desc: "Monitor solar generation and consumption in real time across all your sites.",          category: "Solar", group: "solar", color: "from-green-500 to-emerald-500",  accent: "#16a34a", slug: null },
  { id:28, icon: AreaChart,       name: "Solar Analytics",    tagline: "AI yield & ROI forecasting",           desc: "AI-powered performance analytics, yield forecasting and ROI dashboards.",               category: "Solar", group: "solar", color: "from-violet-500 to-purple-600",  accent: "#7c3aed", slug: null },
  { id:29, icon: Wrench,          name: "Field Service",      tagline: "O&M job & technician management",      desc: "Schedule and dispatch technicians, track O&M jobs, and manage SLAs.",                  category: "Solar", group: "solar", color: "from-cyan-500 to-sky-600",       accent: "#0891b2", slug: null },
  { id:30, icon: CloudSun,        name: "Weather Intelligence",tagline: "Irradiance & weather forecasting",    desc: "Hyperlocal weather data and irradiance forecasting to optimise solar generation.",       category: "Solar", group: "solar", color: "from-orange-400 to-amber-500",   accent: "#ea580c", slug: null },
  { id:31, icon: MonitorCheck,    name: "Asset Management",   tagline: "Panel & inverter tracking",            desc: "Track panels, inverters and batteries with automated fault detection and alerting.",     category: "Solar", group: "solar", color: "from-red-500 to-rose-500",       accent: "#dc2626", slug: null },
  { id:32, icon: Activity,        name: "Grid Connect",       tagline: "Net metering & utility integration",   desc: "Seamless net metering, export billing, and utility grid integration.",                  category: "Solar", group: "solar", color: "from-purple-500 to-violet-600",  accent: "#9333ea", slug: null },
  { id:33, icon: Thermometer,     name: "Thermal Scanner",    tagline: "AI thermal anomaly detection",         desc: "AI-driven thermal imaging and anomaly detection to maximise panel uptime.",              category: "Solar", group: "solar", color: "from-orange-600 to-red-500",     accent: "#c2410c", slug: null },
  { id:34, icon: DollarSign,      name: "Solar Finance",      tagline: "Project financing & subsidy claims",   desc: "Manage project financing, EMI schedules, and subsidy claims in one unified portal.",    category: "Solar", group: "solar", color: "from-blue-500 to-indigo-600",    accent: "#2563eb", slug: null },
];
